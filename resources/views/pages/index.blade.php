    ...
    <main id="page-content">
        ...
        <div class="slider-wrapper theme-default">
            <div id="slider" class="nivoSlider">
                <img src="{{ asset('assets/website') }}/images/slider/slide_1.jpg" title="#htmlcaption1" data-thumb="{{ asset('assets/website') }}/images/slider/slide_1.jpg"
                    alt="" />
                <img src="{{ asset('assets/website') }}/images/slider/slide_2.jpg" title="#htmlcaption2"
                    data-thumb="{{ asset('assets/website') }}/images/slider/slide_2.jpg" alt="" />
                <img src="{{ asset('assets/website') }}/images/slider/slide_3.jpg" title="#htmlcaption3"
                    data-thumb="{{ asset('assets/website') }}/images/slider/slide_3.jpg" alt="" />
            </div>
            ...
            <div id="htmlcaption3" class="nivo-caption">
                <div class="nivo-caption__inner  left-side">
                    <div class="text">
                        <h1 class="showtext showtext__h1">Treat Yourself:<br> Book a Luxury<br> Car Rental</h1>
                        <span class="showtext showtext__link"><a href="#">Luxury Car Rental <br>& Chauffeured
                                Cars</a></span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <form id="book-form" class="book-form" action="#">
                            ...
                            <div class="book-form__btn">
                                <input type="submit" class="btn" id="setDateBtn" data-remodal-target="modal"
                                    value="BOOK NOW">
                            </div>
                        </form>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-lg-6 col-lg-push-6">
                        <h1>Welcome</h1>
                        <p>Hiring a car just got easier with the reliable service of Car Rental Service! Having covered all
                            the 50 states in America, we offer the finest choice of vehicles ranging from economy to luxury.
                        </p>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="post-column">
                                <figure class="thumbnail"><img src="{{ asset('assets/website') }}/images/post-sm-img-1.jpg" alt="">
                                </figure>
                        ...
                        <div class="swiper-slide">
                            <div class="post-column">
                                <figure class="thumbnail"><img src="{{ asset('assets/website') }}/images/post-sm-img-2.jpg" alt="">
                                </figure>
                                <div class="post-column__content">
                        ...
                        <div class="swiper-slide">
                            <div class="post-column">
                                <figure class="thumbnail"><img src="{{ asset('assets/website') }}/images/post-sm-img-3.jpg" alt="">
                                </figure>
                                <div class="post-column__content">
                    ...
                    <div class="swiper-wrapper">
                        <div class="model-info swiper-slide">
                            <figure class="thumbnail">
                                <a href="details.html"><img src="{{ asset('assets/website') }}/images/car_2.png" alt=""></a>
                            </figure>
                            <div class="model-info__content">
                                <h3>Porsche 911 Carrera S</h3>
                                <p>To be clear, the Santa Fe Sport is a 5-passenger SUV with two rows of seating, but I am
                                    testing the regular Santa Fe that is larger and has three rows of seating.</p>
                        ...
                        <div class="model-info swiper-slide">
                            <figure class="thumbnail">
                                <a href="details.html"><img src="{{ asset('assets/website') }}/images/car_1.png" alt=""></a>
                            </figure>
                            <div class="model-info__content">
                        ...
                        <div class="model-info swiper-slide">
                            <figure class="thumbnail">
                                <a href="details.html"><img src="{{ asset('assets/website') }}/images/car_4.png" alt=""></a>
                            </figure>
                            <div class="model-info__content">
                                <h3>Hyundai i30</h3>
                                <p>The series II Hyundai i30 is packed with so many individual and unique features we think
                                    it could be more you than any other small car.</p>
                        ...
                        <div class="model-info swiper-slide">
                            <figure class="thumbnail">
                                <a href="details.html"><img src="{{ asset('assets/website') }}/images/car_3.png" alt=""></a>
                            </figure>
                            <div class="model-info__content">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide odd-line">
                        <div class="service-block">
                            <figure class="thumbnail">
                                <a href="services-post.html"><img src="{{ asset('assets/website') }}/images/service_img_1.jpg"
                                        alt=""></a>
                            </figure>
                            <div class="service-block__content">
                                <h3>24 Hour Airport Services</h3>
                                <p>The best and biggest airport transfer company in the city, Airport Transfers is here to
                                    provide you with the best one-stop transportation service with minimal fuss and maximum
                                    comfort.</p>
                    ...
                    <div class="swiper-slide even-line">
                        <div class="service-block">
                            <figure class="thumbnail">
                                <a href="services-post.html"><img src="{{ asset('assets/website') }}/images/service_img_2.jpg"
                                        alt=""></a>
                            </figure>
                            <div class="service-block__content">
                                <h3>Corporate Meetings &amp; Events</h3>
                                <p>Does your company have employees or clients who frequently rent in the Los Angeles area?
                                    Setting up a corporate account allowsus to pre-deliver vehicles to hotels, offices,
                                    residences.</p>
                                <a href="services-post.html" class="btn btn__marker"><i class="icon-arrows"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide odd-line">
                        <div class="service-block">
                            <figure class="thumbnail">
                                <a href="services-post.html"><img src="{{ asset('assets/website') }}/images/service_img_3.jpg"
                                        alt=""></a>
                            </figure>
                            <div class="service-block__content">
                                <h3>Business Travel</h3>
                                <p>We offer professional drivers who can chauffeur you to any destination you choose. Or ask
                                    for a type of tour or drive you are in the mood for and let us do the rest. </p>
                                <a href="services-post.html" class="btn btn__marker"><i class="icon-arrows"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide even-line">
                        <div class="service-block">
                            <figure class="thumbnail">
                                <a href="services-post.html"><img src="{{ asset('assets/website') }}/images/service_img_4.jpg"
                                        alt=""></a>
                            </figure>
                            <div class="service-block__content">
                                <h3>Private Tours</h3>
                                <p>Huge discounts. Free Delivery and Pickup. Free Car washes. Free upgrades. Free
                                    maintenance. We offer amazing deals on car rental rates. Give us a call we make it easy
                                    and affordable.</p>
                                <a href="services-post.html" class="btn btn__marker"><i class="icon-arrows"></i></a>
                            </div>
                        </div>
                                    ...
                                    <div class="inner_blockquote">
                                        <div class="wrapper">
                                            <p>I was very pleased once again. Hiring online was easy, collection was
                                                straight forward, and returning the car was quick. A very good experience!
                                                Thank you.</p>
                                            <span class="author_info">
                                                <img src="{{ asset('assets/website') }}/images/author_img.png" alt="">
                                    ...
                                    <div class="inner_blockquote">
                                        <div class="wrapper">
                                            <p>This is the second time this year that I have rented a Rental Cars direct
                                                vehicle and the cars were both virtually brand new. Awesome cars and very
                                                kind, helpful staff. Thank you!</p>
                                            <span class="author_info">
                                                <img src="{{ asset('assets/website') }}/images/author_img_1.png" alt="">
                        ...
                        <div class="swiper-slide">
                            <article class="block_tesimonial">
                                <blockquote>
                                    <div class="inner_blockquote">
                                        <div class="wrapper">
                                            <p>Great Service, Absolutely Terrific staff, extremely professional!!! This was
                                                my first ever Car Renting experience, Awesome!!</p>
                                            <span class="author_info">
                                                <img src="{{ asset('assets/website') }}/images/author_img_2.png" alt="">
                                    ...
                                    <div class="inner_blockquote">
                                        <div class="wrapper">
                                            <p>Im really impressed with your staff at all moosa branch, patricia. She has
                                                ...
                                                with you.</p>
                                            <span class="author_info">
                                                <img src="{{ asset('assets/website') }}/images/author_img_3.png" alt="">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide post-item">
                            <div class="post-item__inner">
                                <figure class="thumbnail">
                                    <img src="{{ asset('assets/website') }}/images/item_img-1.jpg" alt="">
                                </figure>
                        ...
                        <div class="swiper-slide post-item">
                            <div class="post-item__inner">
                                <figure class="thumbnail">
                                    <img src="{{ asset('assets/website') }}/images/item_img-2.jpg" alt="">
                                </figure>
                                <div class="post-item__content">
                        ...
                        <div class="swiper-slide post-item">
                            <div class="post-item__inner">
                                <figure class="thumbnail">
                                    <img src="{{ asset('assets/website') }}/images/item_img-3.jpg" alt="">
                                </figure>
                                <div class="post-item__content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="phone-box wow zoomIn">
                        ...
                        <h3 class="phone-box__number">Call Now: <span><i class="icon-telephone"></i> 1-800-123-4567</span>
                        </h3>
                    </div>
                </div>
            </div>
        ...
        <section class="car-info-box" data-wow-duration="1s" data-wow-delay="1s">
            ...
            <figure class="car-info-box__thumb has-second-img">
                ...
                <img src="{{ asset('assets/website') }}/images/car_hire1.jpg" alt="" class="second-fade">
            </figure>
        </section>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="iphone-android_info-box">
                            ...
                            <p><span>Renal Cars App is a car rental marketplace where travelers can rent any car they
                                    want,</span> <span>wherever they want it, from a community of local car owners
                                    throughout the US and Canada.</span></p>
                            <span><a target="_blank" href="https://itunes.apple.com/"><img
                                        src="{{ asset('assets/website') }}/images/app_store.jpg" alt=""></a>
                                <a target="_blank" href="https://play.google.com/store"><img
                                        src="{{ asset('assets/website') }}/images/google_play.jpg" alt=""></a></span>
